    ...
    $.ajax({
        ...
        success: function(data) {
            ...
            for(let i = 0; i < data.length; i++) {
                ...
                + '<div class="card">'
                + '<div class="buy">'
                + '<button type="button" data-id="' + data[i].id + '" data-title="' + data[i].productName + '" data-content="' + data[i].productDec + '" data-price="' + data[i].currentPrice + '" data-img="./assets/frontend/img/product/' + data[i].productImg + '" title="Add to cart" data-bs-toggle="modal" data-bs-target="#cartModal" class="click-cart">'
