    ...
    $.ajax({
        ...
        success: function(data) {
            ...
            for(let i = 0; i < data.length; i++) {
                ...
                + '<div class="card">'
                + '<div class="buy">'
                + '<button type="button" data-id="' + data[i].id + '" data-title="' + data[i].productName + '" data-content="' + data[i].productDec + '" data-price="' + data[i].currentPrice + '" data-img="./assets/img/product/' + data[i].productImg + '" title="Add to cart" data-bs-toggle="modal" data-bs-target="#cartModal" class="click-cart">'
                + '<i class="fa fa-cart-arrow-down"></i>'
                + '</button>'
                + ' </div>'
                + '<img src="./assets/img/product/' + data[i].productImg + '" class="card-img-top" alt="..." height="120">'
                + '<div class="card-body">'
...
function showCarts() {
    ...
    for (var item in cartsList) {
        ...
        //             + '<img src="./assets/img/product/device.jpg" class="rounded" width="80" alt="product image">'
