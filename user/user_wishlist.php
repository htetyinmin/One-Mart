<!-- wishlist -->
<div class="card text-dark bg-light carts view_wishlist">
                        ...
                        <div class="table-responsive">
                            <table class="table table-hover">
                                ...
                                <tbody>
                                    ...
                                    <td class="col-md-2">
                                        <button type="button" class="btn btn-sm" title="Add to Cart"><i class="fas fa-cart-arrow-down"></i></button>
